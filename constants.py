...
# intent loại hoạt động
list_type_activity_notification=["loại hoạt động","loại nào","loại gì","kiểu hoạt động","kiểu gì","kiểu nào"]

# intent tên hoạt động
list_name_activity_notification=["tên gì","tên là gì","tên hoạt động là gì","tên hoạt động","tên các hoạt động","tên những hoạt động","tên một số hoạt động","tên vài hoạt động"]

# intent thời gian
list_time_notification=["là tháng","là ngày","là vào","tháng mấy","thứ mấy","là diễn ra vào","là diễn ra lúc","ngày mấy","khi nào","lúc nào","thời gian nào","ngày nào","ngày bao nhiêu","giờ nào","giờ bao nhiêu","sẽ diễn ra vào","sẽ diễn ra lúc","mấy giờ","mấy h ","thời gian"]
...
list_anything_notification = ["sao cũng được","gì cũng được","anything","s cũng được",\
    'j cũng được',"không biết","k biết","ko biết","không nhớ","ko nhớ","k nhớ","không rõ",\
        "k rõ","ko rõ","cũng được","cũng ok","cũng không trừ ","cũng dc","cũng k sao","cũng ko sao"]
